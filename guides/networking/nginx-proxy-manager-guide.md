...
- v2 stacks deployed and all services reachable at their direct IP:port URLs
...
```bash
docker compose -f /opt/docker/stacks/dashboards-automation/compose.v2.yaml restart homeassistant
```
