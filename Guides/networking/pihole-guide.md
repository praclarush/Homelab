...
Nginx Proxy Manager, Watchtower, ntfy, Tailscale, and CrowdSec.
...
resolve internally without per-service DNS entries. The dnsmasq config
line, reload command, and test are in
[nginx-proxy-manager-guide.md section 4](nginx-proxy-manager-guide.md#section-4-wildcard-dns-in-pi-hole) --
this section covers just the one Pi-hole-specific caveat that guide
doesn't.
