...
```bash
cd Docker/V3/rack-temperature-monitoring/esphome
...
- Move `esphome/rack-ble-proxy.yaml` (without secrets) into a tracked
  location, e.g. `Docker/V2/stacks/dashboards-automation/esphome/`, and add
  a short section to
  `Docker/V2/guides/stacks/dashboards-automation-guide.md` covering it.
- Remove `Docker/V3/rack-temperature-monitoring/` and its row in
  `Docker/V3/README.md`.
