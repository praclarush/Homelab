...
Today, per
[`vlan-reference.md`](../../V2/guides/networking/vlan-reference.md) and
[`netplan-00-installer-config.yaml`](../../V2/config/netplan-00-installer-config.yaml),
...
1. Replace
   [`Docker/V2/config/netplan-00-installer-config.yaml`](../../V2/config/netplan-00-installer-config.yaml)
   ...
   reference copy.
2. Update
   [`Docker/V2/guides/networking/vlan-reference.md`](../../V2/guides/networking/vlan-reference.md):
...
3. Update the netplan row in
   [`Docker/V2/config/README.md`](../../V2/config/README.md) --
...
4. Remove `Docker/V3/dual-nic-vlan-split/` and its row in
   [`Docker/V3/README.md`](../README.md).
