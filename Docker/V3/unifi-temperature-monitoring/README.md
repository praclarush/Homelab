...
- Merge the `unpoller` service into
  `Docker/V2/stacks/dashboards-automation/compose.yaml` and its variables
  into that stack's real `.env.example`.
- Merge the scrape job into
  `Docker/V2/stacks/dashboards-automation/prometheus/prometheus.yml`.
- Add a short section to
  `Docker/V2/guides/stacks/dashboards-automation-guide.md` covering
...
- Remove `Docker/V3/unifi-temperature-monitoring/` and its row in
  `Docker/V3/README.md`.
